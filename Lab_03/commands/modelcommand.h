...
public:
  MoveModel(const double dx, const double dy, const double dz,
            const std::size_t id);
...
public:
  ScaleModel(const double kx, const double ky, const double kz,
             const std::size_t id);
...
public:
  RotateModel(const double ox, const double oy, const double oz,
              const std::size_t id);
...
public:
  TransformModel(const Vertex &move, const Vertex &scale, const Vertex &rotate,
                 const std::size_t id);
...
class GroupModelsCommand : public BaseCommand {
public:
  GroupModelsCommand(const std::vector<std::size_t> &ids,
