...
bool Composite::isVisible() { return false; }

bool Composite::isComposite() { return true; }

void Composite::transform(const Vertex &move, const Vertex &scale,
                          const Vertex &rotate) {
...
Iterator Composite::begin() { return _elements.begin(); }

Iterator Composite::end() { return _elements.end(); }
