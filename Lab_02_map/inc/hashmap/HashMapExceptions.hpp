...
public:
  InvalidKeyException(const char *filename, const char *classname,
...
public:
  InvalidBucketIndexException(const char *filename, const char *classname,
                              const char *method, int line)
...
public:
  InvalidIterator(const char *filename, const char *classname,
                  const char *method, int line)
