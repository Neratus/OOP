...
ConstHashMapIterator<K, V>::ConstHashMapIterator(
    const buckets_iterator &current, const buckets_iterator &end)
    : ConstHashMapIterator(current, end,
...
template <typename K, typename V>
bool ConstHashMapIterator<K, V>::operator==(
    const ConstHashMapIterator<K, V> &iterator) const {
