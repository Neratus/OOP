...
template <CopyNMoveable T> class Matrix : public BaseMatrix {
public:
  class MatrixRow;
...
public:
  ...
  Matrix<T> &
  operator=(const std::initializer_list<std::initializer_list<T>> &values);

  template <typename T1>
    requires MatrixArithmetic<T1, T>
  Matrix &operator=(const Matrix<T1> &matrix);

  template <typename T1>
    requires MatrixArithmetic<T1, T>
  Matrix &operator=(Matrix<T1> &&matrix) noexcept;
  ...
  template <typename T1>
    requires MatrixArithmetic<T1, T>
  auto operator+(const Matrix<T1> &matrix) const;

  template <typename T1>
    requires ElementArithmetic<T1, T>
  auto operator+(const T1 &val) const noexcept;

  template <typename T1>
    requires MatrixArithmetic<T1, T>
  Matrix<T> &addMatrix(const Matrix<T1> &matrix);

  template <typename T1>
    requires ElementArithmetic<T1, T>
  Matrix<T> &addElem(const T1 &val) noexcept;
  ...
  template <typename T1>
    requires ElementArithmetic<T1, T>
  Matrix &operator+=(const T1 &val) noexcept;
  ...
  template <typename T1>
    requires MatrixArithmetic<T1, T>
  Matrix<T> &subMatrix(const Matrix<T1> &matrix);

  template <typename T1>
    requires ElementArithmetic<T1, T>
  auto subElem(const T1 &val) noexcept;
  ...
  SharedPtr<MatrixRow[]> getDataPtr() const noexcept { return this->data; }
  ...
  template <typename T1>
    requires MatrixArithmetic<T1, T>
  Matrix<T> &mulMatrix(const Matrix<T1> &matrix);

  template <typename T1>
    requires ElementArithmetic<T1, T>
  Matrix<T> &mulElem(const T1 &val) noexcept;

  template <typename T1>
    requires Convertable<T1, T>
  Matrix<T> &dot(const Matrix<T1> &matrix);
  ...
  template <typename T1>
    requires MatrixArithmetic<T1, T>
  Matrix<T> &divMatrix(const Matrix<T1> &matrix);

  template <typename T1>
    requires ElementArithmetic<T1, T>
  Matrix<T> &divElem(const T1 &val);
  ...
  template <typename T1>
    requires MatrixArithmetic<T1, T>
  Matrix<T> &operator/=(const Matrix<T1> &matrix);

  template <typename T1>
    requires ElementArithmetic<T1, T>
  Matrix<T> &operator/=(const T1 &val);
  ...
  void resize(const size_t new_row, const size_t new_col,
              const T &fill_value = {});
...
private:
  ...
  template <typename T1>
  bool _CanMultiplyMatrices(const Matrix<T1> &matr) const;
  void _cleanRows();
  void _checkPointer(T **cptr, const size_t len);

  T _MultiplyRowByColumn(const Matrix<T> &matrix, const size_t row,
...
public:
  ...
  public:
    ...
    MatrixRow(const std::initializer_list<T> &);
    ...
    MatrixRow &operator=(const std::initializer_list<T> &values);
